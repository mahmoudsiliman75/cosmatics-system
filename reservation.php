...
<form>
  ...
  <div id="reservation" class="intro-y box px-5 pt-5 pb-5 mt-5">
    <div class="grid grid-cols-12 gap-6">
      ...
      <div class="appended-elements-container col-span-12">
        <div id="chronic-disease-comments" class="hidden col-span-12 sm:col-span-12 md:col-span-6 lg:col-span-4 lg:col-span-8 lg:flex-row pr-3 pl-3 -mx-5">
          <div class="grid grid-cols-12 gap-1 mb-5"> 
            <label class="chronic-disease-name text-gray-600 mt-5 text-lg col-span-12"> Comment </label>
            <input type="text" class="input w-full border mt-2 col-span-10" placeholder="Comments"> 
            <span class="close-comments button translate-y-3 mt-2 mr-2 flex items-center justify-center bg-theme-1 text-white col-span-2"> Remove </span>
          </div>
        </div>
      </div>
